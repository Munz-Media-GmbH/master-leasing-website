      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg, rgba(5,5,5,0.94) 0%, rgba(10,10,10,0.86) 45%, rgba(20,5,5,0.82) 100%)",
            zIndex: 1,
          }}
        />

        {/* Content in container width */}
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <span className="overline">Sale &amp; Leaseback / Fahrzeugbeleihung</span>

          <h1 style={{ color: "#fff", marginBottom: "20px", marginTop: "12px", maxWidth: "680px" }}>
          ...
          <div>
            ...
            >
              <svg width="16" height="16" viewBox="0 0 256 512" fill="currentColor" style={{ flexShrink: 0 }}>
