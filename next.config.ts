    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(), interest-cohort=(), payment=()" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://base.muenzmedia.de https://cloud.ccm19.de https://www.googletagmanager.com",
              ...
              "connect-src 'self' https://base.muenzmedia.de https://cloud.ccm19.de https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com https://*.api.sanity.io wss://*.api.sanity.io https://cdn.sanity.io",
